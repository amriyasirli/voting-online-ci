          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Detail Pemilih</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div class="row">
                ...
                if($pemilih['pemilih_verifikasi'] == 0) {
                    echo "<span class='badge bg-maroon badge-md'>Belum Diverifikasi</span>";
                } else {
                    echo "<span class='badge bg-teal badge-md'>Sudah Diverifikasi</span>";
                }
                ?>
              </div>
              <!-- /.card-body -->
